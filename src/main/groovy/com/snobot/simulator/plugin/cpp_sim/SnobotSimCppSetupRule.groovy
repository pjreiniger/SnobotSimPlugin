...
public class SnobotSimCppSetupRule extends RuleSource {
    ...
    void setupSnobotSimDeps(NativeDepsSpec libs, final ExtensionContainer extensionContainer) {
        ...
        addSnobotSimLibraries(libs, snobotSimExt, wpi)
    }
    ...
    private static void addSnobotSimLibraries(NativeDepsSpec libs, final SnobotSimulatorVersionsExtension snobotSimExt, final WPIExtension wpi) {
